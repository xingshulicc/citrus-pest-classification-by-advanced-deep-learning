...
"""
Created on Tue Nov 20 16:18:45 2018
...
#model_name = inception_resnet_v3
...
wrong_images_folder = os.path.join(os.getcwd(), 'wrong_images')
if not os.path.isdir(wrong_images_folder):
    os.makedirs(wrong_images_folder)

data_path = os.path.join(os.getcwd(), 'project_data/validation')
